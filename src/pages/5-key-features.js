      		...
      		<Container className="pt-5">
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5 mx-0">
					...
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						...
						<p className="filson-pro-reg color-secondary pt-2 text-1">Partner movement while you sleep can be felt across a mattress with traditional coils. This is caused by tossing and turning during the night and can affect the sleep pattern of the person sleeping as well as the partner they are sleeping with.</p>
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5 mx-0">
					...
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						...
						<p className="filson-pro-reg color-secondary pt-2 text-1">One of the most common problems people have which causes them to replace their mattress is sagging. These dips in the mattress are caused by years of use and often lead to great discomfort and irritable sleep.</p>
