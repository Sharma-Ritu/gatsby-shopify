...
export default (props) => {
  return (
	<>
		<Header />
		<section className="blue-bg charity height-350">
				...
				<Row className="charity-inner text-center">
					<Col sm="6" className="mb-3 mb-sm-5">
						<div className="charity-image text-center w-100 pb-2 pb-sm-5">
							<img src={confirm} alt="Confirmity" />
						</div>
					...
					<Col sm="6" className="mb-3 mb-sm-5">
						<div className="charity-image text-center w-100 pb-2 pb-sm-5">
							<img src={support} alt="Support" width="auto"/>
						</div>
					...
					<Col sm="6" className="mb-3 mb-sm-5">
						<div className="charity-image text-center w-100 pb-2 pb-sm-5">
							<img src={alignment} alt="alignment" width="auto"/>
						</div>
					...
					<Col sm="6" className="mb-3 mb-sm-5">
						<div className="charity-image text-center w-100 pb-2 pb-sm-5">
							<img src={presure} alt="Presure Relief" width="auto" />
						</div>
					...
					<Col sm="6" className="mb-3 mb-sm-5">
						<div className="charity-image text-center w-100 pb-2 pb-sm-5">
							<img src={comfort} alt="Comfort" width="auto"/>
						</div>
				...
				<Row className="py-3 py-sm-5">
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="https://massage-matters.ca/" className="w-100 text-center d-block"><img src={massage} alt="Massage" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://www.onehealthcarecentre.com/clinic-hours/" className="w-100 text-center d-block"><img src={one} alt="One Healthcare Center" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://www.santizohealthcare.ca/index.html/" className="w-100 text-center d-block"><img src={antizo} alt="Antizo" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://trillium-rehab.com/" className="w-100 text-center d-block"><img src={trillium} alt="trillium" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://www.mrcdoctors.com/" className="w-100 text-center d-block"><img src={medical} alt="medical" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://www.bodyworkx.ca/" className="w-100 text-center d-block"><img src={health} alt="health" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="https://mobilitypluschiropractic.com/" className="w-100 text-center d-block"><img src={mobility} alt="mobility" /></a>
						</div>
					</Col>
					<Col sm="3" className="mb-3 mb-sm-5">
						<div className="recommend-image">
							<a href="http://ww12.churchwellesleyhealthcentre.com/" className="w-100 text-center d-block"><img src={church} alt="church" /></a>
						</div>
					</Col>
				</Row>
			</div>
		...
		<section>
			<div className="container-large">
				<Row className="py-3 py-sm-5 mb-0 mb-sm-5">
					<p className="space-4 proxima-r color-primary m-auto text-center px-0 px-sm-5 px-lg-5 px-xl-5 pb-2 pb-sm-5" style={{width:'90%',fontSize:'26px'}}>“…the best sleep I’ve had in years.  You don’t need to suffer from back pain to experience the Chirofoam difference.” – Samuel D. from Toronto, Ontario. </p>
					<div className="w-50 m-auto text-center d-flex pt-0 pt-sm-5">
