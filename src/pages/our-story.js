  ...
  return (
	<>
		...
		<section className="mb-0 py-5 position-relative">
			<div className="container-large our-focus pt-5">
				<h4 className="text-center lead-text-font color-primary erbaum-bold text-uppercase w-100" style={{paddingBottom:'100px'}}>Our focus on comfort, support, and health</h4>
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">TODAY’S MATTRESS MARKET</h5>
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					...
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">A GREAT MATTRESS IS FOR YOUR BODY AND MIND</h5>
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">DEVELOPING THE PERFECT MATTRESS</h5>
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					...
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">QUALITY MATERIALS AND SKILLED CRAFTSMANSHIP</h5>
				...
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">EASY DELIVERY AND SET UP IN YOUR HOME</h5>
				...
				<Row className="mb-2 mb-sm-5 pb-0">
					...
					<div className="col-12 col-sm-8 col-lg-8 col-xl-8 left-card">
						<h5 className="erbaum-bold color-primary pb-2 pb-sm-5">WE GUARANTEEE YOUR SATISFACTION</h5>
