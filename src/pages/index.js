					...
					<Col sm="6">
						<img src={mattress1} alt="Mattress1" width="100%"/>
						 <ul className="list-unstyled d-flex float-right mt-3 extra-link">
							  <li className="mr-1 mr-sm-1 mr-lg-3"><Link to="/our-story/" className="mr-sm-3 mr-lg-3 mr-xl-3 color-primary erbaum-bold space-1 position-relative story" style={{fontSize:'13px'}}>OUR STORY</Link></li>
							  <li className="mr-1 mr-sm-1 mr-lg-3"><Link to="/locations/" className="mr-sm-3 mr-lg-3 mr-xl-3 color-primary erbaum-bold space-1 position-relative location" style={{fontSize:'13px'}}>LOCATIONS</Link></li>
							  <li className="mr-1 mr-sm-1 mr-lg-3"><Link to="/shop-chirofoam/" className="mr-sm-3 mr-lg-3 mr-xl-3 color-primary erbaum-bold space-1 position-relative online" style={{fontSize:'13px'}}>BUY ONLINE</Link></li>
						</ul> 
					</Col>
				</Row>
			</div>
		...
		<section className="py-4 pt-sm-0 pb-sm-5 key-feature">
			<Container className="py-0 pt-sm-0 pb-sm-5">
				<Row className="pb-sm-5 pb-0">
					...
					<p className="text-center pb-4 pb-sm-4 pt-2 mb-5 color-primary proxima-b m-auto col-12 col-sm-7 space-1">Designed by mattress experts with 5 key features that consumers voted most important for a comfortable sleep experience. (Most mattresses don’t succeed in all 5 areas.) </p>
					<div style={{margin:'0px auto'}} className="d-inline-block d-sm-flex no-gutters mt-4 mt-sm-5 pt-0 pt-sm-4 pb-0 pb-sm-5 animation-box col-sm-12 col-lg-11 col-xl-11">
						<Col col className="pb-0 pb-sm-5">
							<div className="card-bg1 card-bg bg-image mb-4 mb-sm-0">
								<div className="card-layer">
									<h3 className="display-4 pt-0 pt-sm-3 text-right text-white pr-3 erbaum-bold">01</h3>
						...
						<Col col className="pb-0 pb-sm-5">
							<div className="card-bg2 card-bg bg-image mb-4 mb-sm-0">
								<div className="card-layer">
									<h3 className="display-4 pt-0 pt-sm-3 text-right text-white pr-3 erbaum-bold">02</h3>
									<div className="text-white position-absolute fixed-bottom p-3">
						...
						<Col col className="pb-0 pb-sm-5">
							<div className="card-bg4 card-bg bg-image mb-4 mb-sm-0">
								<div className="card-layer">
									<h3 className="display-4 pt-0 pt-sm-3 text-right text-white pr-3 erbaum-bold">04</h3>
									<div className="text-white position-absolute fixed-bottom p-3">
										<h4 className="erbaum-bold pr-0 pr-sm-0 pr-lg-2 pf-xl-5 text-uppercase" style={{fontSize:'18px'}}>Eliminates motion transfer </h4>
										<p className="proxima-eb" style={{fontSize:'10px', letterSpacing:'1px'}}>Partner movement while you sleep can be felt across a mattress with traditional coils. This is caused by tossing and turning during the night and can affect the sleep pattern of the person sleeping as well as the partner they are sleeping with.</p>
									</div>
								</div>
							</div>
						</Col>
						<Col col className="pb-0 pb-sm-5">
							<div className="card-bg5 card-bg bg-image mb-4 mb-sm-0">
								<div className="card-layer">
									<h3 className="display-4 pt-0 pt-sm-3 text-right text-white pr-3 erbaum-bold">05</h3>
									<div className="text-white position-absolute fixed-bottom p-3">
										<h4 className="erbaum-bold pr-0 pr-sm-0 pr-lg-2 pf-xl-5 text-uppercase" style={{fontSize:'18px'}}>Resists sagging</h4>
										<p className="proxima-eb" style={{fontSize:'10px', letterSpacing:'1px'}}>One of the most common problems people have which causes them to replace their mattress is sagging. These dips in the mattress are caused by years of use and often lead to great discomfort and irritable sleep.</p>
									</div>
								</div>
							</div>
						</Col>
				...
				<Row className="no-gutters row-eq-height pb-5">
					<Col sm="6" className="product-border-right pr-0 pr-sm-2 position-relative">
						<div className="pr-5 mr-0 mr-sm-4">
							...
							<p className="text-left text-sm-right color-primary proxima-eb space-1 mb-0">
							...
							<p className="text-left text-sm-right mb-4 color-primary proxima-eb space-1 mb-0">
								Profile: 12 inches
							</p><br />
						</div>
