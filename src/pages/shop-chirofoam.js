				...
				<Row>
					<Col sm="6" className="position-relative" style={{zIndex:'9'}}>
						...
						<p className="cta erbaum pt-3">
							<Link to="#-cta" onClick={(e) => e.preventDefault()} className="color-primary">CALL TO ACTION <i className="fa fa-caret-right ic1"></i><i className="fa fa-caret-right ic2"></i><i className="fa fa-caret-right ic3"></i></Link>
						</p>
					</Col>
					<Col sm="6">
