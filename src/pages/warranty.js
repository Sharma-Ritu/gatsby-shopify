	...
	<>
		...
		<section className="blue-bg warranty-banner height-350">
			<Jumbotron className="mb-0 text-center text-white bg-transparent space-1 Jumbotron">
				<h2 className="font-weight-bold display-5 erbaum-bold text-uppercase pt-5 space-2">CHIROFOAM™ MEMORY FOAM MATTRESS</h2>
			...
			<div className="container-large our-focus">
				<Row className="py-0 py-sm-5">
					<div className="col-12">
						<h4 className="text-center lead-text-font color-primary erbaum-bold w-100 pb-2 pb-sm-5 mb-0 mb-sm-5">WARRANTY</h4>
						...
						<h5 className="erbaum-bold color-primary py-2 py-sm-5 my-0 my-sm-5">CHIROFOAM™ LIMITED 15 YEAR WARRANTY</h5>
						<p className="filson-pro-reg color-secondary">If you observe a defect, contact us directly through our Chirofoam™ website. We can be contacted through email warranty@chirofoam.com with your warranty issue.</p>
						<p className="filson-pro-reg color-secondary">You must, within the duration of the warranty, provide the original law tags (with registration number and regulatory tag information), proof of purchase including date of purchase and be the original purchasing consumer.</p>
						<p className="filson-pro-reg color-secondary"> If defective in workmanship or material, your Chirofoam™ mattress and will be repaired or replaced (at our option) with charges, as shown on the Warranty Schedule and exclusive of transportation and inspection costs.</p>
						<p className="filson-pro-reg color-secondary">All other claims including incidental or consequential damages are precluded. If identical materials are not available at the time of repair or replacement, the manufacturer reserves the right to substitute materials of comparable quality.</p>
						<p className="filson-pro-reg color-secondary">Any and all implied warranties on this product shall not exceed in duration the term of this limited warranty.</p>
						<p className="filson-pro-reg color-secondary">This warranty begins on the day you purchase your mattress. Warranty is prorated for the period of 15 years based on purchase price of the mattress. If your sleep set is repaired or replaced, this limited warranty will not be renewed or extended.</p>
						<p className="filson-pro-reg color-secondary">Some provinces do not allow the exclusion or limitation of incidental or consequential damages or limitations on how long an implied warranty lasts, so the above limitation or exclusion may not apply.</p>
						<h5 className="erbaum-bold color-primary py-2 py-sm-3 my-0" style={{fontSize:'16px'}}>WARRANTY COVERAGE DETAIL</h5>
						<p className="filson-pro-reg color-secondary">The Chirofoam™ Limited Warranty covers only the following items during normal wear:</p>
						<h5 className="erbaum-bold color-primary py-2 py-sm-3 my-0" style={{fontSize:'16px'}}>MATTRESS:</h5>
						<p className="filson-pro-reg color-secondary">Sagging or Body Impressions that measure 11/2” or greater, only if the mattress has been continuously supported by foundation and used with an appropriate frame with center support, or a minimum of 12 cross slats with center support that extends to the floor.</p>
						<p className="filson-pro-reg color-secondary">The Chirofoam™ Limited Warranty does NOT cover items not expressly listed below, such as, but not limited to:
							<ul className="pl-3">
