			...
			<Container>
				<Row className="mb-2 mb-sm-5 pb-0 pb-sm-5">
					<div className="col-12">
						...
						<p className="filson-pro-reg color-secondary">Please ensure that your mattress is clean and free from any stains.  Refunds are issued once the mattress is received and inspected for damages and stains or upon receiving the charitable receipt. Mattresses must be returned in good condition, with all instructions, warranties, and original serial numbers (located on the mattress new material tags as well as the label attached to the box your mattress was shipped in).  Note that returned mattress cannot be resold as they are considered personal care items.  We will strive to donate your mattress to a charity or foundation which accepts used mattresses.</p>
						<p className="filson-pro-reg color-secondary">Please state the reason for your return when contacting us as we use this information to improve our products and your feedback is greatly appreciated.</p>
						<p className="filson-pro-reg color-secondary">Carefully package the mattress using the original bag, or any other heavy duty mattress bag, and/or mattress box for extra protection.</p>
						<p className="filson-pro-reg color-secondary">Once we receive your mattress and confirm the return, we will process your refund in full on the original method of payment used for purchase within 2-5 business days.  Please note that it may take a little longer for the funds to process and display back on to your original method of payment.</p>
						<h3 className="display-5 erbaum-bold font-weight-bold color-primary space-2 text-center pt-5">AFTER THE 100 NIGHT SLEEP TRIAL</h3>
