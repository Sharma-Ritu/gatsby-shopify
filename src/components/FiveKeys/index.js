              ...
              <div className="card-bg4 keys card-bg bg-image mb-4 mb-sm-0">
                <div className="card-layer">
                  ...
                  <div className="card-data text-white position-absolute p-3">
                    ...
                    <p className="proxima-eb text-1" style={{letterSpacing:'1px'}}>Partner movement while you sleep can be felt across a mattress with traditional coils. This is caused by tossing and turning during the night and can affect the sleep pattern of the person sleeping as well as the partner they are sleeping with.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-bg5 keys card-bg bg-image mb-4 mb-sm-0">
                <div className="card-layer">
                  ...
                  <div className="card-data text-white position-absolute p-3">
                    ...
                    <p className="proxima-eb text-1" style={{letterSpacing:'1px'}}>One of the most common problems people have which causes them to replace their mattress is sagging. These dips in the mattress are caused by years of use and often lead to great discomfort and irritable sleep.</p>
                  </div>
                </div>
              </div>
            </div>
