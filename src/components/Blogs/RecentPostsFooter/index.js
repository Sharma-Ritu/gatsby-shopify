  ...
  return (
          ...
          <Col sm="3" className="" key={id}>
            <div className="recenet-post-inner border">
              <Link to={`/blogs/${url.split("/").pop()}/`} className="recent-post-image position-relative overflow-hidden d-block" style={{height:'200px'}}>
              ...
              <Link to={`/blogs/${url.split("/").pop()}/`} className="recent-post-title">
