			...
			<Row className="proxima-r pt-5 pb-3 px-0 px-sm-2">
				<Col md="3" className="widget-1 pt-0 pt-sm-1">
					...
					<ul style={{
						...
						<li className="mr-2 pr-1"><Link to="/"><i className="fa fa-facebook color-primary"></i></Link></li>
						<li className="mr-2 pr-1"><Link to="/"><i className="fa fa-instagram color-primary"></i></Link></li>
						<li className="mr-2 pr-1"><Link to="/"><i className="fa fa-twitter color-primary"></i></Link></li>
