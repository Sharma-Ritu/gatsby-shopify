			...
			<div className="">
				<Row>
					...
					<Col md="6" className="text-center banner-home" style={{right:'0'}}>			
						<p className="leads filson-pro-reg space-4 pt-2 animated slideInDown slow">CHIROFOAM MEMORY FOAM MATTRESS</p>
						<h2 className="erbaum-bold space-4 pl-sm-0 pl-xl-4 pl-lg-4 animated slideInLeft slow" style={{fontStyle:'italic'}}>UPGRADE</h2>
						<h3 className="erbaum animated slideInRight slow">YOUR SLEEP</h3>
